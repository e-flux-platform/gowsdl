...
type LocalDateTimeType struct {
	...
	// HERE3
	LocalDateTime string `xml:"LocalDateTime,omitempty" json:"LocalDateTime,omitempty"`
}
...
type EmtId struct {
	...
	// HERE3
	TokenSubType string `xml:"tokenSubType,omitempty" json:"tokenSubType,omitempty"`
	...
	Representation string `xml:"representation,attr,omitempty" json:"representation,omitempty"`
}
...
type CdrStatusType struct {
	...
	// HERE3
	CdrStatusType string `xml:"CdrStatusType,omitempty" json:"CdrStatusType,omitempty"`
}
...
type ConnectorType struct {
	...
	//
	// HERE5
	ConnectorStandard *ConnectorStandard `xml:"connectorStandard,omitempty" json:"connectorStandard,omitempty"`
	...
	//
	// HERE5
	ConnectorFormat *ConnectorFormat `xml:"connectorFormat,omitempty" json:"connectorFormat,omitempty"`

	//
	// References a tariff uploaded by the CPO to be used with this connector.
	//
	// HERE5
	TariffId *TariffId `xml:"tariffId,omitempty" json:"tariffId,omitempty"`
}

// RatingsType one two three
type RatingsType struct {
	...
	//
	// HERE5
	MaximumPower float32 `xml:"maximumPower,omitempty" json:"maximumPower,omitempty"`

	//
	// The minimum guaranteed mean power in case of load management. Should be set to maximum when no load management applied.
	//
	// HERE5
	GuaranteedPower float32 `xml:"guaranteedPower,omitempty" json:"guaranteedPower,omitempty"`
	...
	// HERE3
	NominalVoltage int32 `xml:"nominalVoltage,omitempty" json:"nominalVoltage,omitempty"`
}

type ParkingSpotInfo struct {
	XMLName xml.Name `xml:"parkingSpot"`

	//
	// Globally unique identifier for this parking spot.
	//
	// HERE5
	ParkingId *ParkingId `xml:"parkingId,omitempty" json:"parkingId,omitempty"`
	...
	// HERE3
	FloorLevel string `xml:"floorLevel,omitempty" json:"floorLevel,omitempty"`
	...
	// HERE3
	ParkingSpotNumber string `xml:"parkingSpotNumber,omitempty" json:"parkingSpotNumber,omitempty"`
}
...
type CdrPeriodType struct {
	...
	//
	// HERE5
	StartDateTime *LocalDateTimeType `xml:"startDateTime,omitempty" json:"startDateTime,omitempty"`

	//
	// Ending time of the period. Must be equal or earlier than endDateTime of the CDRInfo
	//
	// HERE5
	EndDateTime *LocalDateTimeType `xml:"endDateTime,omitempty" json:"endDateTime,omitempty"`

	//
	// Defines what the EVSP is charged for during this period
	//
	// HERE5
	BillingItem *BillingItemType `xml:"billingItem,omitempty" json:"billingItem,omitempty"`

	//
	// The value the EVSP is charged for. The unit of the value depends on the billingItem.
	//
	// HERE5
	BillingValue float32 `xml:"billingValue,omitempty" json:"billingValue,omitempty"`

	//
	// Price per unit of the billingItem in the given currency.
	//
	// HERE5
	ItemPrice float32 `xml:"itemPrice,omitempty" json:"itemPrice,omitempty"`

	//
	// The cost of the period in the given currency.
	//
	// HERE5
	PeriodCost float32 `xml:"periodCost,omitempty" json:"periodCost,omitempty"`

	//
	// Tax rate in percent that is to be paid for charging processes in the country of origin.
	//
	// HERE5
	Taxrate int32 `xml:"taxrate,omitempty" json:"taxrate,omitempty"`
}

type BillingItemType struct {
	// HERE3
	BillingItemType string `xml:"BillingItemType,omitempty" json:"BillingItemType,omitempty"`
}

type GeoPointType struct {
	XMLName xml.Name `xml:"chargePointLocation"`

	//
	// Latitude of the Point in decimal degree. Example: 50.104965 Decimal separator: "." Regex: -?[0-9]{1,2}\.[0-9]{6}
	//

	Lat string `xml:"lat,attr,omitempty" json:"lat,omitempty"`

	//
	// Longitude of the decimal degree Example: -126.104965 Decimal separator: "." Regex: -?[0-9]{1,3}\.[0-9]{6}
	//

	Lon string `xml:"lon,attr,omitempty" json:"lon,omitempty"`
}

type AdditionalGeoPointType struct {
	XMLName xml.Name `xml:"relatedLocation"`
...
type ConnectorStandard struct {
	// HERE3
	ConnectorStandard string `xml:"ConnectorStandard,omitempty" json:"ConnectorStandard,omitempty"`
}

type HoursType struct {
	XMLName xml.Name `xml:"openingTimes"`
	...
	//
	// HERE5
	ExceptionalOpenings []*ExceptionalPeriodType `xml:"exceptionalOpenings,omitempty" json:"exceptionalOpenings,omitempty"`
	...
	//
	// HERE5
	ExceptionalClosings []*ExceptionalPeriodType `xml:"exceptionalClosings,omitempty" json:"exceptionalClosings,omitempty"`
	...
	//
	// HERE5
	ClosedCharging bool `xml:"closedCharging,omitempty" json:"closedCharging,omitempty"`

	//
	// Regular hours, weekday based. This element should not be set for representing 24/7.
	//
	// HERE5
	RegularHours *RegularHoursType `xml:"regularHours,omitempty" json:"regularHours,omitempty"`

	//
	// True to represent 24 hours per day and 7 days per week, except the given exceptions.
	//
	// HERE5
	Twentyfourseven bool `xml:"twentyfourseven,omitempty" json:"twentyfourseven,omitempty"`
}
...
type ChargePointStatusType struct {
	...
	// HERE3
	ChargePointStatusType string `xml:"ChargePointStatusType,omitempty" json:"ChargePointStatusType,omitempty"`
}

type ChargePointScheduleType struct {
	XMLName xml.Name `xml:"statusSchedule"`

	//
	// Begin of scheduled period.
	//
	// HERE5
	StartDate *DateTimeType `xml:"startDate,omitempty" json:"startDate,omitempty"`

	//
	// End of scheduled period, if known.
	//
	// HERE5
	EndDate *DateTimeType `xml:"endDate,omitempty" json:"endDate,omitempty"`

	//
	// Status value during the scheduled period.
	//
	// HERE5
	Status *ChargePointStatusType `xml:"status,omitempty" json:"status,omitempty"`
}
...
type GeneralLocationType struct {
	...
	// HERE3
	GeneralLocationType string `xml:"GeneralLocationType,omitempty" json:"GeneralLocationType,omitempty"`
}
...
type RestrictionType struct {
	...
	// HERE3
	RestrictionType string `xml:"RestrictionType,omitempty" json:"RestrictionType,omitempty"`
}

type AuthMethodType struct {
	XMLName xml.Name `xml:"authMethods"`

	// HERE3
	AuthMethodType string `xml:"AuthMethodType,omitempty" json:"AuthMethodType,omitempty"`
}

type RegularHoursType struct {
	XMLName xml.Name `xml:"regularHours"`

	//
	// Number of day in the week, beginning with Monday(1) until Sunday (7).
	//

	Weekday int32 `xml:"weekday,attr,omitempty" json:"weekday,omitempty"`
	...
	PeriodBegin string `xml:"periodBegin,attr,omitempty" json:"periodBegin,omitempty"`

	//
	// End of the regular period, syntax as for periodBegin. Must be later than periodBegin.
	//

	PeriodEnd string `xml:"periodEnd,attr,omitempty" json:"periodEnd,omitempty"`
}
...
type ExceptionalPeriodType struct {
	...
	//
	// HERE5
	PeriodBegin *DateTimeType `xml:"periodBegin,omitempty" json:"periodBegin,omitempty"`

	//
	// End of exception
	//
	// HERE5
	PeriodEnd *DateTimeType `xml:"periodEnd,omitempty" json:"periodEnd,omitempty"`
}
...
type ConnectorFormat struct {
	...
	// HERE3
	ConnectorFormat string `xml:"ConnectorFormat,omitempty" json:"ConnectorFormat,omitempty"`
}

type ResultCodeType struct {
	XMLName xml.Name `xml:"resultCode"`
...
type EvseImageUrlType struct {
	...
	// HERE3
	ThumbUri string `xml:"thumbUri,omitempty" json:"thumbUri,omitempty"`
...
type IndividualTariffType struct {
	XMLName xml.Name `xml:"individualTariff"`

	//
	// Contains information about the pricing structure of the tariff element.
	//
	// HERE5
	TariffElement []*TariffElementType `xml:"tariffElement,omitempty" json:"tariffElement,omitempty"`
...
type TariffElementType struct {
	XMLName xml.Name `xml:"tariffElement"`

	//
	// Contains information about the pricing structure of the tariff element.
	//
	// HERE5
	PriceComponent *PriceComponentType `xml:"priceComponent,omitempty" json:"priceComponent,omitempty"`

	//
	// Contains information about when to apply the defined priceComponent / tariffElement.
	//
	// HERE5
	TariffRestriction *TariffRestrictionType `xml:"tariffRestriction,omitempty" json:"tariffRestriction,omitempty"`
}

type PriceComponentType struct {
	XMLName xml.Name `xml:"priceComponent"`
	...
	//
	// HERE5
	StepSize float32 `xml:"stepSize,omitempty" json:"stepSize,omitempty"`
}

type TariffRestrictionType struct {
	XMLName xml.Name `xml:"tariffRestriction"`
	...
	//
	// HERE5
	StartDateTime *DateTimeType `xml:"startDateTime,omitempty" json:"startDateTime,omitempty"`

	//
	// Valid until this date/time.
	//
	// HERE5
	EndDateTime *DateTimeType `xml:"endDateTime,omitempty" json:"endDateTime,omitempty"`

	//
	// Minimum energy used in kWh. Valid from this amount used.
	//
	// HERE5
	MinEnergy float32 `xml:"minEnergy,omitempty" json:"minEnergy,omitempty"`

	//
	// Maximum energy used in kWh. Valid up to this amount used.
	//
	// HERE5
	MaxEnergy float32 `xml:"maxEnergy,omitempty" json:"maxEnergy,omitempty"`

	//
	// Minimum power in kW. Valid from this power.
	//
	// HERE5
	MinPower float32 `xml:"minPower,omitempty" json:"minPower,omitempty"`

	//
	// Maximum power in kW. Valid up to this power.
	//
	// HERE5
	MaxPower float32 `xml:"maxPower,omitempty" json:"maxPower,omitempty"`

	//
	// Minimum duration in seconds. Valid from this duration.
	//
	// HERE5
	MinDuration int32 `xml:"minDuration,omitempty" json:"minDuration,omitempty"`

	//
	// Maximum duration in seconds. Valid up to this duration.
	//
	// HERE5
	MaxDuration int32 `xml:"maxDuration,omitempty" json:"maxDuration,omitempty"`
}
...
type RoamingAuthorisationInfo struct {
	...
	//
	// HERE5
	EmtId *EmtId `xml:"EmtId,omitempty" json:"EmtId,omitempty"`

	//
	// EMA-ID the token belongs to.
	//
	// HERE5
	ContractId *ContractId `xml:"contractId,omitempty" json:"contractId,omitempty"`
	...
	// HERE3
	PrintedNumber string `xml:"printedNumber,omitempty" json:"printedNumber,omitempty"`
	...
	//
	// HERE5
	ExpiryDate *DateTimeType `xml:"expiryDate,omitempty" json:"expiryDate,omitempty"`
}
...
type CDRInfo struct {
	...
	//
	// HERE5
	CdrId *CdrId `xml:"CdrId,omitempty" json:"CdrId,omitempty"`
	...
	//
	// HERE5
	EvseId *EvseId `xml:"evseId,omitempty" json:"evseId,omitempty"`
	...
	//
	// HERE5
	Status *CdrStatusType `xml:"status,omitempty" json:"status,omitempty"`
	...
	//
	// HERE5
	ChargePointAddress *AddressType `xml:"chargePointAddress,omitempty" json:"chargePointAddress,omitempty"`
	...
	// HERE3
	ChargePointType string `xml:"chargePointType,omitempty" json:"chargePointType,omitempty"`

	//
	// Type of utilized socket or connector
	//
	// HERE5
	ConnectorType *ConnectorType `xml:"connectorType,omitempty" json:"connectorType,omitempty"`

	//
	// Defines the ratings for the charge point.
	//
	// HERE5
	Ratings *RatingsType `xml:"ratings,omitempty" json:"ratings,omitempty"`
	...
	// HERE3
	MeterId string `xml:"meterId,omitempty" json:"meterId,omitempty"`

	//
	// One period per item on the bill.
	//
	// HERE5
	ChargingPeriods []*CdrPeriodType `xml:"chargingPeriods,omitempty" json:"chargingPeriods,omitempty"`

	//
	// Total cost for the entire charging process. Should always equal the sum of the individual periodCosts.
	//
	// HERE5
	TotalCost float32 `xml:"totalCost,omitempty" json:"totalCost,omitempty"`
...
type ChargePointInfo struct {
	...
	//
	// HERE5
	Timestamp *DateTimeType `xml:"timestamp,omitempty" json:"timestamp,omitempty"`
	...
	// HERE3
	LocationNameLang string `xml:"locationNameLang,omitempty" json:"locationNameLang,omitempty"`

	// HERE5
	Images []*EvseImageUrlType `xml:"images,omitempty" json:"images,omitempty"`

	// HERE5
	RelatedResource []*RelatedResourceType `xml:"relatedResource,omitempty" json:"relatedResource,omitempty"`
	...
	//
	// HERE5
	ChargePointLocation *GeoPointType `xml:"chargePointLocation,omitempty" json:"chargePointLocation,omitempty"`

	//
	// Geographical location of related points relevant to the user
	//
	// HERE5
	RelatedLocation []*AdditionalGeoPointType `xml:"relatedLocation,omitempty" json:"relatedLocation,omitempty"`
	...
	//
	// HERE5
	OpeningTimes *HoursType `xml:"openingTimes,omitempty" json:"openingTimes,omitempty"`
	...
	//
	// HERE5
	StatusSchedule []*ChargePointScheduleType `xml:"statusSchedule,omitempty" json:"statusSchedule,omitempty"`
	...
	//
	// HERE5
	Location *GeneralLocationType `xml:"location,omitempty" json:"location,omitempty"`

	//
	// Information regarding a parking spot that can be used to access the EVSE.
	//
	// HERE5
	ParkingSpot []*ParkingSpotInfo `xml:"parkingSpot,omitempty" json:"parkingSpot,omitempty"`
	...
	// HERE5
	AuthMethods []*AuthMethodType `xml:"authMethods,omitempty" json:"authMethods,omitempty"`

	//
	// Which receptable type is/are present for a power outlet.
	//
	// HERE5
	Connectors []*ConnectorType `xml:"connectors,omitempty" json:"connectors,omitempty"`
	...
	// HERE3
	UserInterfaceLang string `xml:"userInterfaceLang,omitempty" json:"userInterfaceLang,omitempty"`
	...
	// HERE3
	MaxReservation int32 `xml:"maxReservation,omitempty" json:"maxReservation,omitempty"`
}
...
type TariffInfo struct {
	...
	//
	// HERE5
	IndividualTariff []*IndividualTariffType `xml:"individualTariff,omitempty" json:"individualTariff,omitempty"`
}
...
type EvseStatusType struct {
	...
	Major string `xml:"major,attr,omitempty" json:"major,omitempty"`
	...
	Minor string `xml:"minor,attr,omitempty" json:"minor,omitempty"`
	...
	Ttl soap.XSDDateTime `xml:"ttl,attr,omitempty" json:"ttl,omitempty"`
}
...
type AddCDRsRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 AddCDRsRequest"`
	...
	//
	// HERE5
	CdrInfoArray []*CDRInfo `xml:"cdrInfoArray,omitempty" json:"cdrInfoArray,omitempty"`
}

type AddCDRsResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 AddCDRsResponse"`
	...
	//
	// HERE5
	ImplausibleCdrsArray []*CdrId `xml:"implausibleCdrsArray,omitempty" json:"implausibleCdrsArray,omitempty"`
}

type GetCDRsRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetCDRsRequest"`
	...
	//
	// HERE5
	CdrStatus *CdrStatusType `xml:"cdrStatus,omitempty" json:"cdrStatus,omitempty"`
}

type GetCDRsResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetCDRsResponse"`
...
type CheckCDRsRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 CheckCDRsRequest"`
...
type CheckCDRsResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 CheckCDRsResponse"`
...
type GetRoamingAuthorisationListRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetRoamingAuthorisationListRequest"`
}

type GetRoamingAuthorisationListResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetRoamingAuthorisationListResponse"`
	...
	//
	// HERE5
	RoamingAuthorisationInfoArray []*RoamingAuthorisationInfo `xml:"roamingAuthorisationInfoArray,omitempty" json:"roamingAuthorisationInfoArray,omitempty"`
}

type SetRoamingAuthorisationListRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 SetRoamingAuthorisationListRequest"`
...
type SetRoamingAuthorisationListResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 SetRoamingAuthorisationListResponse"`
	...
	//
	// HERE5
	RefusedRoamingAuthorisationInfo []*RoamingAuthorisationInfo `xml:"refusedRoamingAuthorisationInfo,omitempty" json:"refusedRoamingAuthorisationInfo,omitempty"`
}

type GetChargePointListRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetChargePointListRequest"`
}

type GetChargePointListResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetChargePointListResponse"`
	...
	//
	// HERE5
	ChargePointInfoArray []*ChargePointInfo `xml:"chargePointInfoArray,omitempty" json:"chargePointInfoArray,omitempty"`
}

type SetChargePointListRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 SetChargePointListRequest"`
...
type SetChargePointListResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 SetChargePointListResponse"`
	...
	//
	// HERE5
	RefusedChargePointInfo []*ChargePointInfo `xml:"refusedChargePointInfo,omitempty" json:"refusedChargePointInfo,omitempty"`
}

type GetRoamingAuthorisationListUpdatesRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetRoamingAuthorisationListUpdatesRequest"`

	//
	// Date and time since the last successful call of GetRoamingAuthorisationList.req or GetRoamingAuthorisationListUpdate.req
	//
	// HERE5
	LastUpdate *DateTimeType `xml:"lastUpdate,omitempty" json:"lastUpdate,omitempty"`
}

type GetRoamingAuthorisationListUpdatesResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetRoamingAuthorisationListUpdatesResponse"`
	...
	//
	// HERE5
	RoamingAuthorisationInfo []*RoamingAuthorisationInfo `xml:"http://ochp.eu/1.4 roamingAuthorisationInfo,omitempty" json:"roamingAuthorisationInfo,omitempty"`
}

type UpdateRoamingAuthorisationListRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateRoamingAuthorisationListRequest"`
...
type UpdateRoamingAuthorisationListResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateRoamingAuthorisationListResponse"`
...
type ConfirmCDRsRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 ConfirmCDRsRequest"`
	...
	Approved []struct {
		...
		// HERE5
		EvseId *EvseId `xml:"evseId,omitempty" json:"evseId,omitempty"`
	} `xml:"approved,omitempty" json:"approved,omitempty"`
	...
	Declined []struct {
		...
		//
		// HERE5
		CdrId *CdrId `xml:"http://ochp.eu/1.4 cdrId,omitempty" json:"cdrId,omitempty"`
		...
		// HERE5
		EvseId *EvseId `xml:"evseId,omitempty" json:"evseId,omitempty"`
	} `xml:"declined,omitempty" json:"declined,omitempty"`
}

type ConfirmCDRsResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 ConfirmCDRsResponse"`
...
type GetChargePointListUpdatesRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetChargePointListUpdatesRequest"`
...
type GetChargePointListUpdatesResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetChargePointListUpdatesResponse"`
...
type UpdateChargePointListRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateChargePointListRequest"`
...
type UpdateChargePointListResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateChargePointListResponse"`
...
type UpdateTariffsRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateTariffsRequest"`

	//
	// This contains the tariff information to be updated or added.
	//
	// HERE5
	TariffInfoArray []*TariffInfo `xml:"TariffInfoArray,omitempty" json:"TariffInfoArray,omitempty"`
}

type UpdateTariffsResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateTariffsResponse"`
	...
	//
	// HERE5
	RefusedTariffInfo []*TariffInfo `xml:"refusedTariffInfo,omitempty" json:"refusedTariffInfo,omitempty"`
}

type GetTariffUpdatesRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetTariffUpdatesRequest"`
...
type GetTariffUpdatesResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetTariffUpdatesResponse"`
...
type GetSingleRoamingAuthorisationRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetSingleRoamingAuthorisationRequest"`
...
type GetSingleRoamingAuthorisationResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetSingleRoamingAuthorisationResponse"`
	...
	//
	// HERE5
	RoamingAuthorisationInfo *RoamingAuthorisationInfo `xml:"roamingAuthorisationInfo,omitempty" json:"roamingAuthorisationInfo,omitempty"`
}

type UpdateStatusRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateStatusRequest"`

	//
	// This contains one EVSE id with the current status represented in a major part and a minor part.
	//
	// HERE5
	Evse []*EvseStatusType `xml:"evse,omitempty" json:"evse,omitempty"`

	//
	// This contains one parking-ID with the current corresponding status.
	//
	// HERE5
	Parking []*ParkingStatusType `xml:"parking,omitempty" json:"parking,omitempty"`

	//
	// The time to live is set as the deadline till the status values are to be considered valid, where not otherwise specified.
	//
	// HERE5
	Ttl *DateTimeType `xml:"ttl,omitempty" json:"ttl,omitempty"`
}

type UpdateStatusResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateStatusResponse"`
...
type GetStatusRequest struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetStatusRequest"`
	...
	// HERE3
	StatusType string `xml:"statusType,omitempty" json:"statusType,omitempty"`
}

type GetStatusResponse struct {
	// XXX
	XMLName xml.Name `xml:"http://ochp.eu/1.4 GetStatusResponse"`

	//
	// Status values for all EVSE that have been combined with parking status values according to static POI data.
	//
	// HERE5
	Combined []*EvseStatusType `xml:"combined,omitempty" json:"combined,omitempty"`
...
type Result struct {
	...
	// HERE3
	ResultDescription string `xml:"resultDescription,omitempty" json:"resultDescription,omitempty"`
}
...
type OCHP_1_4 interface {
	...
	*/
	AddCDRs(ctx context.Context, cdrInfoArray []CDRInfo) error
	...
	*/
	GetCDRs(ctx context.Context, cdrStatus CdrStatusType) ([]*CDRInfo, error)
...
type AddCDRsPartialFailure struct {
	implausibleCdrsArray []CdrId
	wrapped              error
}

func NewAddCDRsPartialFailure(wrapped error, implausibleCdrsArray []CdrId) AddCDRsPartialFailure {
	return AddCDRsPartialFailure{
		implausibleCdrsArray: implausibleCdrsArray,
		wrapped:              wrapped,
	}
}

func (a AddCDRsPartialFailure) Error() string {
	return ""
}

func (a AddCDRsPartialFailure) FailedItems() []CdrId {
	return a.implausibleCdrsArray
}

func (a AddCDRsPartialFailure) Unwrap() error {
	return a.wrapped
}

func (service *oCHP_1_4) AddCDRs(ctx context.Context, cdrInfoArray []CDRInfo) error {
	var response struct {
		XMLName              xml.Name `xml:"http://ochp.eu/1.4 AddCDRsResponse"`
		Result               Result   `xml:"result,omitempty" json:"result,omitempty"`
		ImplausibleCdrsArray []CdrId  `xml:"implausibleCdrsArray,omitempty" json:"implausibleCdrsArray,omitempty"`
	}
	err := service.client.CallContext(
		ctx,
		...
		struct {
			...
			CdrInfoArray: cdrInfoArray,
		},
		&response,
	)

	if response.ImplausibleCdrsArray != nil && len(response.ImplausibleCdrsArray) != 0 {
		return NewAddCDRsPartialFailure(err, response.ImplausibleCdrsArray)
	}

	return err
}

func (service *oCHP_1_4) GetCDRs(ctx context.Context, cdrStatus CdrStatusType) ([]*CDRInfo, error) {
	var response struct {
	...
	if response.Result.ResultCode.ResultCode != "ok" {
		return response.CdrInfoArray, fmt.Errorf("something %s %s", response.Result.ResultCode.ResultCode, response.Result.ResultDescription)
	}

	return response.CdrInfoArray, nil
}
...
type OCHP_1_4_live interface {
	...
	*/
	UpdateStatus(ctx context.Context, evse []EvseStatusType, parking []ParkingStatusType, ttl DateTimeType) error

	/*
		A NPS may receive the current live status of individual charging stations from the Clearing House.
	*/
	GetStatus(ctx context.Context, startDateTime DateTimeType, statusType string) (combined []EvseStatusType, evse []EvseStatusType, parking []ParkingStatusType, err error)
}
...
func (service *oCHP_1_4_live) UpdateStatus(ctx context.Context, evse []EvseStatusType, parking []ParkingStatusType, ttl DateTimeType) error {
	var response struct {
		XMLName xml.Name `xml:"http://ochp.eu/1.4 UpdateStatusResponse"`
		Result  *Result  `xml:"result,omitempty" json:"result,omitempty"`
	}
	err := service.client.CallContext(ctx,
...
func (service *oCHP_1_4_live) GetStatus(ctx context.Context, startDateTime DateTimeType, statusType string) (combined []EvseStatusType, evse []EvseStatusType, parking []ParkingStatusType, err error) {
	var response struct {
		XMLName  xml.Name            `xml:"http://ochp.eu/1.4 GetStatusResponse"`
		Combined []EvseStatusType    `xml:"combined,omitempty" json:"combined,omitempty"`
		Evse     []EvseStatusType    `xml:"evse,omitempty" json:"evse,omitempty"`
	...
	return response.Combined, response.Evse, response.Parking, nil
}
